...
@Entity
@Table(name = "TB_DOING")
public class TaskModelDoing extends RepresentationModel<TaskModelDoing> implements Serializable{
    ...
    public boolean equals(Object o) {
        ...
        TaskModelDoing that = (TaskModelDoing) o;
